/****************************************************************************
** Meta object code from reading C++ file 'myTime.h'
**
...
#error "The header file 'myTime.h' doesn't include <QObject>."
...
void MyTime::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        MyTime *_t = static_cast<MyTime *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject MyTime::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_MyTime.data,
